...
var JornadaPage = /** @class */ (function () {
    ...
    JornadaPage.prototype.save = function () {
        if (this.selected.length != 2) {
            ...
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__modal_jornada_modal_jornada__["a" /* ModalJornadaPage */], { "local": this.selected[0], "visitante": this.selected[1] });
